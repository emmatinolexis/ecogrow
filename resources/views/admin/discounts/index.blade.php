...
@section('content')
    <div class="container">
        <h2>Discounts</h2>
        <a href="{{ route('discounts.create') }}" class="btn btn-create mb-3 ripple-surface">Add Discount</a>
        @if(session('success'))
            ...
            <tbody>
                @foreach($discounts as $discount)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('discounts.edit', $discount) }}" class="btn btn-edit btn-sm">Edit</a>
