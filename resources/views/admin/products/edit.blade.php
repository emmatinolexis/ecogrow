...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('products.update', $product) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="discount_id" class="form-control">
                            ...
                            @foreach($discounts as $discount)
                                <option value="{{ $discount->id }}" {{ $product->discounts->first() && $product->discounts->first()->id == $discount->id ? 'selected' : '' }}>
            ...
            <button type="submit" class="btn btn-update mt-3">Update Product</button>
